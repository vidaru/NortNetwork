...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"northern", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"northern", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use northernd, or the -server option to northern-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
