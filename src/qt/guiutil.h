...
/** Utility functions used by the Northern Qt UI.
 */
namespace GUIUtil
{
...
// Render Northern addresses in monospace font
...
// Parse "northern:" URI into recipient object, return true on successful parsing
