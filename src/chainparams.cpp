...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000a63e25f6f8f60b48448ba156a1bbec1a4bb21d5c1a49cc8b7a1aa33d4bd"));
	
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1506779999, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Northern: 1 minute
        ...
        nZerocoinStartTime = 1506779999;
		nZerocoinStartHeight = 30;
		
		const char* pszTimestamp = "New 05-02-2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1506779999;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 99730;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000a63e25f6f8f60b48448ba156a1bbec1a4bb21d5c1a49cc8b7a1aa33d4bd"));
        assert(genesis.hashMerkleRoot == uint256("0x8d1e1871019488f3afa9092fb73e9a6f6aec1e73b01fa969e12934c92b469e8d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("nort.network", "node.nort.network"));
...
public:
    CRegTestParams()
    {
        ...
        assert(hashGenesisBlock == uint256("0x2bbe4d5ad6000fe10e2343875debb13a51429d0b8a621c72efdbfc3f23997eba"));
