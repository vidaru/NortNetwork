...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Northern address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNORT"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Northern"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Northern addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Northern addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Northern Core help message to get a list with possible Northern command-line options"));
