...
In order to support loading of multiple wallets in northern-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is northern.cpp.
...
Changes to northern.cpp
----------------------
northern.cpp is the entry point into northern-qt, and as such, will require some minor modifications to provide hooks for
