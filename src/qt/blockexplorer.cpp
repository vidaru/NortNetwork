...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#009231;}\n a, span { font-family: monospace; }\n span.addr {color:#009231; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #009231;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#009231;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#009231;}\n";
