                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received NORT from zNORT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNORT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNORT));
